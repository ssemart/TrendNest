                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Category name must be between 5 and 100 characters.</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="featured_order" name="featured_order" value="{{ old('featured_order', 0) }}" min="0">
