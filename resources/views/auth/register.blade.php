<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="form">
        ...
        <div class="flex-column">
            <label>Name</label>
            <div class="inputForm @error('name') input-error @enderror">
                <svg height="20" viewBox="0 0 32 32" width="20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 15.503A5.041 5.041 0 1 0 16 5.42a5.041 5.041 0 0 0 0 10.083zm0 2.215c-6.703 0-11 3.699-11 5.5v3.363h22v-3.363c0-2.178-4.068-5.5-11-5.5z"/>
                </svg>
                <input type="text" name="name" class="input" placeholder="Enter your Name" value="{{ old('name') }}" required autofocus>
            </div>
            @error('name')
        ...
        <div class="flex-column">
            ...
            <div class="inputForm @error('email') input-error @enderror">
                ...
                <input type="email" name="email" class="input" placeholder="Enter your Email" value="{{ old('email') }}" required>
            </div>
            @error('email')
                <div class="error-message">{{ $message }}</div>
            @enderror
        ...
        <div class="flex-column">
            ...
            <div class="inputForm @error('password') input-error @enderror">
        ...
        <div class="flex-column">
            ...
            <div class="inputForm">
                <svg height="20" viewBox="-64 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path></svg>
                <input type="password" name="password_confirmation" class="input" placeholder="Confirm your Password" required>
            </div>
        </div>
